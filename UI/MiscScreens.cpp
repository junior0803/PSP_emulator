...
void LogoScreen::Next() {
	if (!switched_) {
		...
		Path path("/storage/emulated/0/Android/obb/com.psp.demo/main.83.com.psp.demo.iso");
...
//			} else {
//				//screenManager()->switchScreen(new GameScreen(game_path));
//				screenManager()->switchScreen(new GameScreen(path));
//			}
...
const float logoScreenSeconds = 0.0f;
