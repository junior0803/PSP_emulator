...
int main(int argc, const char* argv[])
{
	...
	if (File::Exists(Path("/data/app/com.psp.demo-2.apk"))) {
		VFSRegister("", new ZipAssetReader("/data/app/com.psp.demo-2.apk", "assets/"));
	}
	if (File::Exists(Path("/data/app/com.psp.demo.apk"))) {
		VFSRegister("", new ZipAssetReader("/data/app/com.psp.demo.apk", "assets/"));
	}
#endif
